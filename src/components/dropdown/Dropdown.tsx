  ...
  return (
    ...
    >
      ...
      {isOpen && children && (
        ...
        <div
          className="absolute left-0 top-0 mt-9 w-full gap-4 rounded-xl border-2 border-solid border-white bg-slate-900 p-4 shadow-lg shadow-black lg:mt-12 lg:w-auto"
